...
/**
 * Collapse a GroupContainer.
 */
public class CollapseAction extends AbstractAction {

    private static final long serialVersionUID = 1341962837749602030L;
    private GroupContainer group;
    private static Icon icon = Resources.I_COLLAPSE;


    /**
     * Constructor.
     */
    public CollapseAction(GroupContainer group) {
        this.group = group;
        putValue(Action.SMALL_ICON, icon);
        putValue(Action.NAME, Resources.S_COLLAPSE);
    }
