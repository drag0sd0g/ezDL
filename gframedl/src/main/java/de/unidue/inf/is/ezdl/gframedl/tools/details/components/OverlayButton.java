...
/**
 * Overlay buttons are used in DetailViewContainer.
 */
public class OverlayButton extends JButton implements ActionListener {

    private static final long serialVersionUID = -1275757546636810788L;


    /**
     * The Styles which could be used for Display the button. The SOLID-style is
     * the Default.
     */
    public enum Style {
        SOLID, BBORDER, TRANSPARENT
    }
     ...
     * buttons size depends on actions icon size, normally 22x22 is used.
     */
    public OverlayButton(Action a) {
        super(a);
        setOpaque(false);
    ...
    private final MouseListener buttonMouseListener = new MouseAdapter() {
        ...
        public void mouseEntered(MouseEvent e) {
            ...
            if (component instanceof OverlayButton) {
                OverlayButton button = (OverlayButton) component;
