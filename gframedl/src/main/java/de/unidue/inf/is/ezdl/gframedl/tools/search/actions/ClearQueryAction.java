...
public final class ClearQueryAction extends AbstractAction {
    ...
    public ClearQueryAction() {
        super(I18nSupport.getInstance().getLocString("ezdl.search.controls.clear"), Icons.CLEAR_ACTION.get16x16());
