...
public class StoreQueryHistoryNotify implements MessageContent {

    private static final long serialVersionUID = -290797812849846261L;

    private String sessionId;
    private HistoricQuery historicQuery;


    public StoreQueryHistoryNotify(String sessionId, HistoricQuery historicQuery) {
        super();
    ...
    public HistoricQuery getHistoricQuery() {
