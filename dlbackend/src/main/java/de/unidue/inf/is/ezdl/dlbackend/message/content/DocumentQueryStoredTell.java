...
public class DocumentQueryStoredTell extends AbstractStoredDocumentTell {
     ...
     *            the result list
     */
    public DocumentQueryStoredTell(StoredDocumentList results) {
     ...
     */
    public DocumentQueryStoredTell(StoredDocumentList results, int totalDocCount) {
        super(results);
    ...
    public String toString() {
        return toInnerString("DocumentQueryStoredTell");
    }
