...
public class DefaultCNFTransformer extends AbstractNFTransformer {

    @Override
    public boolean invertNegation(int index, String binaryString) {
        return TruthTableCreator.boolValue(index, binaryString);
    }


    @Override
    public NodeType innerNodeType() {
        return NodeType.OR;
    }


    @Override
    public NodeType outerNodeType() {
        return NodeType.AND;
    }
