...
public class AllBooleanNodesQueryTreeWalker extends AbstractDefaultOrderQueryTreeWalker {

    private List<QueryNodeBool> queryNodes = new ArrayList<QueryNodeBool>();
    ...
    public List<QueryNodeBool> getQueryNodes() {
        return queryNodes;
    }
}
