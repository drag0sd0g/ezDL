 ...
 * @author RT
 */
public class GroupByAuthors extends GroupByRelation {
    ...
    public String getName() {
        return i18n.getLocString("ezdl.grouping.relations.authors");
    }
    ...
    public EquivalenceClass assignObject(Object o) {
        ...
        String authors = ri.getAuthors();
        result = new EquivalenceClass(authors, null);
