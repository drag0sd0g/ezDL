...
public class DetailedProjection implements Projection {

    private I18nSupport i18n = I18nSupport.getInstance();
    private static final Icon IMAGE_ICON = Icons.DETAILED_VIEW_ACTION.get16x16();
    ...
    public String getName() {
        return i18n.getLocString("ezdl.controls.resultlistpanel.label.view.detailed");
    }
