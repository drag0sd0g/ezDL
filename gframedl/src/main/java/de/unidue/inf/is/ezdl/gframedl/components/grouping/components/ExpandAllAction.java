...
/**
 * Expand all groups of a GroupsContainer.
 * 
 * @author RB1
 */
public class ExpandAllAction extends AbstractAction {
    ...
    private static Icon icon = Resources.I_EXPAND_ALL;


    /**
     * Constructor.
     */
    public ExpandAllAction(GroupsContainer groups) {
        this.groups = groups;
        putValue(Action.SMALL_ICON, icon);
        putValue(Action.NAME, Resources.S_EXPAND_ALL);
    }
