...
/**
 * Select a group in the Grouped list.
 * 
 * @author RB1
 */
public class SelectGroupAction extends AbstractAction {

    private static final long serialVersionUID = 1L;

    private static Icon icon = Resources.I_SELECT_GROUP;
     ...
     * @param group
     */
    public SelectGroupAction(GroupedList list, EquivalenceClass group) {
        super();
        this.list = list;
        this.group = group;
        putValue(Action.SMALL_ICON, icon);
        putValue(Action.NAME, Resources.S_SELECT_GROUP);
    }


    @Override
    public void actionPerformed(ActionEvent arg0) {
        list.selectGroup(group);
    }
}
