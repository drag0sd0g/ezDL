...
/**
 * The PORTER stemming algorithm, which is fully described in "An algorithm for
 * suffix stripping", M.F. Porter (1980), _Program_, Vol. 14, No. 3, pp. 130-137
 * * conf/mind/stopwords.
 * 
 * @author John Keyes (keyeg@ils.unc.edu)
 * @since January 3, 1998
 * @status finished January 3, 1998
 */
public class PorterStemmer implements Stemmer {

    @Override
    public String stem(String str) {
        return getStemmed(str);
    }
