 ...
 */
public final class BasicQueryView extends JPanel implements QueryView {
     ...
     */
    public BasicQueryView(AbstractQueryPanel qp) {
    ...
    public void updateWithHistoricQuery(QueryNode andNode) {
        ...
        String queryString = queryFactory.getTextForQueryNode(q, DEFAULT);
        queryArea.setText(queryString);
