...
/** Add a group */
public class AddGroupNotify implements MessageContent {

    private static final long serialVersionUID = -19568499228981005L;
    ...
    public AddGroupNotify(String sessionId, Group g, List<Document> documents, ReferenceSystem referenceSystem) {
